...
void Rw2Decoder::decodeRawInternal() {
  ...
  if (isOldPanasonic) {
    ...
    case 4: {
      ...
      PanasonicDecompressorV4 p(mRaw.get(), bs, hints.has("zero_is_not_bad"),
    ...
    case 5: {
      PanasonicDecompressorV5 v5(mRaw.get(), bs, bitsPerSample);
      mRaw->createData();
      v5.decompress();
      return;
    }
    case 6: {
      PanasonicDecompressorV6 v6(mRaw.get(), bs);
      mRaw->createData();
      v6.decompress();
      return;
    }
